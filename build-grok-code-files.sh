...
./file_printer.sh ./samples Empty-DOM.html Tagged-Container.html Untagged-Container-With-Grandparent-With-Aria-Label.html Untagged-Container-With-Messages-Open.html Untagged-Container-With-Parent-Without-Aria-Label.html >> grok/3-xGhosted.src.dom.test.txt || { show_progress "Error: execution failed"; exit 1; }
