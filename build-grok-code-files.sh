...
./file_printer.sh -t ./src >> grok/3-xGhosted.src.txt || { show_progress "Error: execution failed"; exit 1; }
...
./file_printer.sh -t ./src/utils >> grok/3-xGhosted.src.utils.txt || { show_progress "Error: execution failed"; exit 1; }