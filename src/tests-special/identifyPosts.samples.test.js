...
describe("identifyPosts - Conversation Threads", () => {
  ...
  it("Should find problem adjacent reply to post with sensitive content warning", () => {
    loadHTML("samples/ajw-with-reply-to-content-notification-post.html");
    const analyses = identifyPosts(document);
    ...
    expect(analyses).toEqual([
      {
        ...
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918590170313503208",
        text: "Might? Sounds like all!",
      },
      {
        connector: postConnector.DIVIDES,
      ...
      {
        connector: postConnector.INDEPENDENT,
      ...
      {
        connector: postConnector.STARTS,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/Brooketaylortv/status/1918370892633235745",
        text: "Team coverage with who has taught me the ropes here since my first day",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918589589108797857",
        text: "You both do a great job! Thank you.",
      },
      {
        connector: postConnector.DIVIDES,
        quality: postQuality.DIVIDER,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/Rothmus/status/1918425502877962631",
        text: "",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918588492994523291",
        text: 'They figured, "Why exploit a crisis when you can simply direct attention to one empathetic thing while doing unthinkable things with untraceable money instead." They were getting away with it until those meddling kids went to D.C. and poked their noses into everything.',
      },
      {
        connector: postConnector.DIVIDES,
        quality: postQuality.DIVIDER,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/TB1Kinobe/status/1918543393707249691",
        text: "When you see it!",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918586247565476191",
        text: "You know, when you need to run a wire from one place to somewhere else and don't want to drill new holes. What else could you do?",
      },
      {
        connector: postConnector.DIVIDES,
        quality: postQuality.DIVIDER,
      ...
      },
      {
        ...
        reason: "Found notice: content warning",
        link: "/Ronald_vanLoon/status/1918583118501482544",
        text: "Medivis’ technology transforms complex 2D imaging, like MRI and CT scans, into real-time holographic\nby @Medivis_AR    cc:",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.PROBLEM_ADJACENT,
        reason: "Problem upstream in converation thread",
        link: "/ApostleJohnW/status/1918584385327993321",
        text: "Wow! That's a fantastic application of combined data visualization!",
      },
      {
        connector: postConnector.DIVIDES,
        quality: postQuality.DIVIDER,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/RogueLou18/status/1918581669491294328",
        text: "Mike about to be honorary first question in WH press room tomorrow. \n\nI hope it’s overtly descriptive and Karoline answers candid then everyone else in there gets super uncomfortable.",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918582428718735674",
        text: "This should be interesting. Thanks for the heads up.",
      },
      {
        connector: postConnector.DIVIDES,
        quality: postQuality.DIVIDER,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918466042302497165",
        text: "Hosting xAI’s Grok on Azure is a great move, Microsoft! Now build Grok into Bing and Copilot!",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/leggah7/status/1918524904464339413",
        text: "What ? This is cool, this is very cool. Let them build together bigger",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918581630517592272",
        text: "Indeed",
      },
      {
        connector: postConnector.DIVIDES,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/Rothmus/status/1918461401200280001",
        text: "",
      },
      {
        connector: postConnector.CONTINUES,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/MariRoz100/status/1918502523704402224",
        text: "Nice set up, enjoy!",
      },
      {
        connector: postConnector.CONTINUES,
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/ApostleJohnW/status/1918581377856909670",
        text: "Thanks!",
      },
      {
        connector: postConnector.DIVIDES,
      ...
      },
      {
        ...
        quality: postQuality.GOOD,
        reason: "Looks good",
        link: "/notyouneek/status/1918496155320668431",
        text: "There's some great information in this for those who are learning to speak in public.",
      },
    ]);
  });
});
