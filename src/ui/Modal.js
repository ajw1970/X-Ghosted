function Modal({ isOpen, onClose, onSubmit, mode, config }) {
    ...
    }, window.preact.h("div", { className: "modal-file-input-container" }, window.preact.h("input", {
        type: "file",
    ...
    }), window.preact.h("div", { className: "modal-button-container" }, window.preact.h("button", {
